...
namespace NWebp.Internal.dec
{
	...
	{
		#if USE_GENERIC_TREE
		static const sbyte kYModesIntra4[18] = {
		  -B_DC_PRED, 1,
			-B_TM_PRED, 2,
			  -B_VE_PRED, 3,
				4, 6,
		...
		static const sbyte kYModesInter[8] = {
		  -DC_PRED, 1,
			2, 3,
			  -V_PRED, -H_PRED,
			  -TM_PRED, -B_PRED
		...
		static const sbyte kMBSplit[6] = {
		  -3, 1,
			-2, 2,
			  -0, -1
		};

		static const sbyte kMVRef[8] = {
		  -ZEROMV, 1,
			-NEARESTMV, 2,
			  -NEARMV, 3,
				-NEWMV, -SPLITMV
		...
		// Inter
		#if !ONLY_KEYFRAME_CODE
		static const byte kYModeProbaInter0[4] = { 112, 86, 140, 37 };
		static const byte kUVModeProbaInter0[3] = { 162, 101, 204 };
		static const byte kMVProba0[2][NUM_MV_PROBAS] = {
		...
		void VP8ParseIntraMode(VP8BitReader* const br,  VP8Decoder* const dec) {
		  byte* const top = dec->intra_t_ + 4 * dec->mb_x_;
		  byte* const left = dec->intra_l_;
		  ...
		  if (!dec->is_i4x4_) {
			...
			for (y = 0; y < 4; ++y) {
			  ...
			  int x;
			  for (x = 0; x < 4; ++x) {
				const byte* const prob = kBModesProba[top[x]][ymode];
		#if USE_GENERIC_TREE
		...
		#if !ONLY_KEYFRAME_CODE
		static const byte MVUpdateProba[2][NUM_MV_PROBAS] = {
