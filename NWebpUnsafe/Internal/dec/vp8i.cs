...
namespace NWebp.Internal
{
	...
	unsafe public partial class VP8Proba
	{
		...
		fixed byte ymode_[4];
		fixed byte uvmode_[3];
		fixed byte mv_[2, NUM_MV_PROBAS];
#endif
	}
	...
	/// Filter parameters
	/// </summary>
	public unsafe struct VP8FilterHeader
	{
		public int simple_;                  // 0=complex, 1=simple
		public int level_;                   // [0..63]
		public int sharpness_;               // [0..7]
		public int use_lf_delta_;
		public fixed int ref_lf_delta_[(int)_NUMEnum.NUM_REF_LF_DELTAS];
		public fixed int mode_lf_delta_[(int)_NUMEnum.NUM_MODE_LF_DELTAS];
	}
	...
	public struct VP8FInfo
	{
		...
		*/
		public uint f_level_ { get { throw (new NotImplementedException()); } set { throw (new NotImplementedException()); } }
		public uint f_ilevel_ { get { throw (new NotImplementedException()); } set { throw (new NotImplementedException()); } }
		public uint f_inner_ { get { throw (new NotImplementedException()); } set { throw (new NotImplementedException()); } }
	}
	...
	/// </summary>
	unsafe public struct VP8ThreadContext
	{
		/// <summary>
	...
	unsafe partial class VP8Decoder
	{
		...
		public byte[] intra_l_ = new byte[4];  // left intra modes values
		...
		/// </summary>
		public byte filter_levels_ = new byte[(int)_NUMEnum.NUM_MB_SEGMENTS];
